// This screen contains the machine safety check form
/**
 * This screen contains the machine safety check form
 * It allows users to fill out and submit machine safety inspections.
 * The form includes fields for site, zone, item type, item name,
 * subchecks with pass/fail toggles, and an overall comment.
 */
...
const MachineSafetyCheckForm: React.FC<Props> = ({ navigation, route }) => {
 ...
 // Load sites and item types on mount
  ...
  useEffect(() => {
    ...
    api.itemTypes("Machine Safety").then(r => setItemTypes(r.data ?? [])).catch(() => setItemTypes([]));
  }, []);
    ...
    <View style={globalStyles.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingVertical: 10 }}>
        <View style={globalStyles.card}>
          <Text style={globalStyles.cardTitle}>Machine Safety Check</Text>
